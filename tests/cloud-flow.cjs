...
const ctx={S:{level:1,stats:{time:1}},B:null,ACC:{uid:'u1'},cloudReady:true,cloudBusy:false,cloudLoading:false,cloudConflict:false,cloudHold:0,Number,Date,JSON,Object,
