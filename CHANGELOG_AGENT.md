...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 2026-09-11 09:40 | Claude Code | FEAT-025 | ecos-v26: código de rescate de un solo uso para recuperar la cuenta sin el PIN (cierra #10 del backlog) | (este commit) | npm test 59/59 · CI de navegador · SQL en el proyecto real | Sí ecos-v26 | Nadie ha recuperado aún una cuenta real desde el móvil |
