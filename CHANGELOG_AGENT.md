...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 2026-09-11 15:05 | Claude Code | FEAT-031 | ecos-v31: habilidades como sellos en una fila y arena más grande (187 px), avatar sin recuadro, filtros de rareza en mochila y mascotas con ficha al tocar, avisos discretos y mapa bajo la isla dinámica | (este commit) | npm test 73/73 · CI de navegador en Chromium 320/390/430/1280 + PWA · contraste y área táctil a cero fallos | Sí ecos-v31 | El área táctil ampliada de la «i» se la comía la habilidad vecina: medido y sustituido por el nombre entero |
