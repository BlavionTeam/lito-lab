# Lito Lab · HISTORIAL (archivo)

> **NO leer por defecto.** Este archivo existe solo para consultar el porqué de una
> decisión concreta. El estado vigente está en `CONTINUAR.md`; el registro de sesiones
> en `CHANGELOG_AGENT.md`; las tareas con ID en `TAREAS.md`.
> Contenido congelado el 2026-09-07 (UTC), volcado del antiguo `CONTINUAR.md`.
> Las referencias `#NN` de aquí son numeración del roadmap XLSM de Drive; su equivalencia
> con los IDs actuales está en `TAREAS.md`.
