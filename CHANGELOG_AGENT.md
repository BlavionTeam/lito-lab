...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 2026-09-08 12:20 | sesión Claude Code | TECH-002 | QA de PWA en CI: manifest, service worker y juego sin red | d3c7371 | check + 8 suites + PWA local en Chromium | No | Ninguna |
